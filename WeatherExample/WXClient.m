...
- (RACSignal *)fetchCurrentConditionsForLocation:(CLLocationCoordinate2D)coordinate {
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://api.openweathermap.org/data/2.5/weather?APPID=3aa1c3ee74c66741a81f405bc39f841c&lat=%f&lon=%f&units=imperial",coordinate.latitude, coordinate.longitude];
...
- (RACSignal *)fetchHourlyForecastForLocation:(CLLocationCoordinate2D)coordinate {
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://api.openweathermap.org/data/2.5/forecast?APPID=3aa1c3ee74c66741a81f405bc39f841c&lat=%f&lon=%f&units=imperial&cnt=12", coordinate.latitude, coordinate.longitude];
    
    NSURL *url = [NSURL URLWithString:urlString]; //your job is to set url here
